...
map("n", "<leader><space>", "<cmd>lua require('alternate-toggler').toggleAlternate()<CR>")

-- buffer

map("n", "f.", ":BufferLineCycleNext<CR>")
map("n", "f,", ":BufferLineCyclePrev<CR>")
...
-- Mark
map("n", "<space>fm", ":Telescope vim_bookmarks all<CR>")
map("n", "<space>fc", ":Telescope vim_bookmarks current_file<CR>")
...
-- git
map("n", "<Leader>gi", ":GitBlameToggle<CR>")
